      ...
      <div>
        <div className='gap-y-4 max-w-100 lg:max-w-5xl justify-center mx-auto mt-24 pb-1 lg:pb-20'>
          ...
          <div className='w-full justify-between cookie'>
            <span onClick={()=> chooseEventList(0)} className={`${!choice ? 'underline text-neutral-900' : 'text-neutral-500'} text-3xl mx-4 lg:text-6xl`}>
              <img src="/assets/icons/tech.svg" alt="" className='w-6 h-6 mx-1 inline'/>
              Technical
            </span>
            <span onClick={()=> chooseEventList(1)} className={`${!choice ? 'text-neutral-500' : 'underline text-neutral-900'} text-3xl mx-4 lg:text-6xl`}>
