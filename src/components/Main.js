...
function Main() {
  return (
    <>
      ...
      {/* img-bg-2 */}
        <h2 className='text-5xl lg:text-6xl text-white mb-5 text-center cookie'>About Ekna'22</h2>
        ...
        <div className='flex flex-wrap w-full py-10 justify-center items-center'>
          ...
          <div className='w-4/5 mx-auto lg:w-1/2'>
            ...
            <p className='text-cyan-500 text-lg'>To register for various events with just ₹150 of ticket</p>
          </div>
        </div>
